...
from models.SeqAtt import SeqAttClassifier
...
class CONFIG_PARAS():
    def __init__(self):
        ...
        self.model_save_path = "./models_trained/20ng_news/seqatt_model"
        self.batch_size = 128
...
if __name__ == "__main__":
    ...
    # mode: (RNN, LSTM, GRU)
    model = SeqAttClassifier(args.hidden, args.max_sentence_length, embedding_matrix, args.n_class,
                             args.dropout, bidirectional=args.bidirection, attention_size=args.attention_size)
